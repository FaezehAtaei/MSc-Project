...
# defining memory augmented autoencoder model for CIFAR-10
class Mem_AE_CIFAR(nn.Module):
    def __init__(self):
        super(Mem_AE_CIFAR, self).__init__()
        ...
        # memory
        self.mem_rep = MemModule(mem_dim=500, fea_dim=256, shrink_thres=0.0025)
